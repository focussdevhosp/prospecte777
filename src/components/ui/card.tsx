...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => (
  <div ref={ref} className={cn("rounded-2xl border border-border bg-card text-card-foreground shadow-[0_4px_20px_-6px_rgba(15,35,60,0.12)] transition-all duration-300", className)} {...props} />
));
