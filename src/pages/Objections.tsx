...
const CATEGORY_META: Record<string, { label: string; color: string }> = {
  ...
  tempo: { label: "⏰ Vou pensar", color: "bg-blue-500/10 text-blue-600 border-blue-500/30" },
  email: { label: "✉️ Manda no email", color: "bg-purple-500/10 text-purple-600 border-purple-500/30" },
  concorrente: { label: "🥊 Já tenho fornecedor", color: "bg-red-500/10 text-red-600 border-red-500/30" },
  autoridade: { label: "👥 Preciso consultar", color: "bg-indigo-500/10 text-indigo-600 border-indigo-500/30" },
  urgencia: { label: "📅 Agora não", color: "bg-orange-500/10 text-orange-600 border-orange-500/30" },
  ceticismo: { label: "🤨 Não acredito", color: "bg-slate-500/10 text-slate-600 border-slate-500/30" },
  resultado: { label: "🎯 Meu caso é único", color: "bg-teal-500/10 text-teal-600 border-teal-500/30" },
  compromisso: { label: "📝 Contrato longo", color: "bg-yellow-500/10 text-yellow-600 border-yellow-500/30" },
  suporte: { label: "🛟 E depois?", color: "bg-cyan-500/10 text-cyan-600 border-cyan-500/30" },
  complexidade: { label: "🧩 Complicado", color: "bg-pink-500/10 text-pink-600 border-pink-500/30" },
  silencio: { label: "🔇 Sumiu", color: "bg-gray-500/10 text-gray-600 border-gray-500/30" },
  reuniao: { label: "🗓️ Sem tempo", color: "bg-lime-500/10 text-lime-600 border-lime-500/30" },
  tentou: { label: "❌ Já tentei", color: "bg-rose-500/10 text-rose-600 border-rose-500/30" },
  crise: { label: "📉 Crise", color: "bg-red-500/10 text-red-700 border-red-500/40" },
};
