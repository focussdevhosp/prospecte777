...
const CATEGORY_META: Record<string, { label: string; color: string }> = {
  ...
  ceticismo: { label: "🤨 Não acredito", color: "bg-muted text-muted-foreground border-border" },
  ...
  silencio: { label: "🔇 Sumiu", color: "bg-muted text-muted-foreground border-border" },
